...
(defpackage fastest-strstr-asd
  (:use :cl :asdf))

(in-package :fastest-strstr-asd)

(asdf:defsystem #:fastest-strstr
  :version "0.0.1"
  ...
  (
   ...
   (:module "libs"
            :pathname "src/libs"
            :components
            ((:file "fastest-strstr.lib.stub")))

   ;; The main module
   (:module "fastest-strstr"
            :pathname "src"
            :depends-on ("libs")
            :components
            ((:file "fastest-strstr")))
   ...
   (:module "t"
            :pathname "t"
            :depends-on ("libs" "fastest-strstr")
            :components
            ((:file "fastest-strstr.run.tests")))
   )
  )
